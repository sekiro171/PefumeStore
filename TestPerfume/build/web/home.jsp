                        ...
                        <div class="section_title">
                            ...
                            <div class="product_tab_btn">
                                <ul class="nav" role="tablist">
                                    <li>
                                        <a href="Home1Servlet?cid=${0}" class="${chid[0]==true?"active":""}">
                                            ALL
                                        </a>
                                    </li>
                                    <c:forEach items="${requestScope.category}" var="c">
                        ...
                        <div class="home_section_left">
                            ...
                            <div class="testimonial_style_two mb-60 rightleft">
                                <div class="testimonial_container">
                                    ...
                                    <form id="f3" action="refine.jsp" method="get">
                                        <div class="" style="margin: 0">
                                            <h2 style="font-size: 16px;"></h2>
                                            <fieldset class="responsiveFacets_sectionContent " aria-hidden="false">
                                                <div href="refine.jsp" class="responsiveFacets_sectionItemLabel" onclick="pageRefine(0)">
                            ...
                            <div class="widgets_container widget_menu">
                                ...
                                <div class="footer_menu">
                                    <ul>
                                        ...
                                        <li><a href="aboutus.jsp">About Us</a></li>
                                        <li><a href="refine.jsp?cid_refine=0">Shopping</a></li>
                                        <li><a href="refine.jsp?cid_refine=5">Gift set</a></li>
