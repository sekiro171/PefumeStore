                        ...
                        <div class="card-body">
                            <div class="table-responsive"  id="contentt">
                                <table  class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text_page_head" scope="col">Price (VNĐ)</th>
                                    ...
                                    <tbody >
                                        <c:forEach items="${listByPage}" var="o">
                                            <tr class="product_items">
                                                ...
                                                <td class="text_page number"> <fmt:formatNumber value="${o.price}" type="number" pattern="0"/> </td>
                                                <td class="text_page">
                                ...
                                <div class="clearfix" style="text-align: center">
                                    <ul class="pagination">
                                        <c:if test="${page != 1}">
                                            <a class="page-item" href="ManagerProductServlet?page=${page-1}">Previous</a>
                                        </c:if> 	
                                        <c:forEach begin="1" end="${numberpage}" var="i">
                                            <a class="${page==i?"page-item activee":""}" style="${page==i?"background-color:black; color: white; font-size: 22px; float: left; padding: 8px 16px; text-decoration: none;":""}" 
                                               href="ManagerProductServlet?page=${i}" class="page-link">${i}</a>  
                                        </c:forEach>
                                        <c:if test="${page < numberpage}">
                                            <a class="page-item" href="ManagerProductServlet?page=${page+1 }" class="page-link">Next</a>
                                        </c:if> 
                                    </ul>
                                </div>
        ...
        <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog" style="margin: 28px 500px">
                <div class="modal-content" style="width: 1000px; max-height: 900px; overflow: scroll">
                    <form action="AddProductServlet" method="get" enctype="multipart/form-data">
