                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_add_to_cart">
                                    ...
                                    <form action = "BankingServlet">
                                        <input  name="balance" type="text" min="25000" max="10000000" step="5" value="25000">
                                        <p style="color: grey">Enter a minimum amount of 25.000 VNĐ and a maximum of 10.000.000 VNĐ</p>
    ...
    <div class="modal-content" style="width:500px; margin: 0 auto">
      ...
      <div class="modal-body" style="font-size: 16px; font-weight: 600">Are you sure you would like to sign out of your account?</div>
        <div class="modal-footer" style="justify-content: center;">
            <div style="width:40%; background-color: white"><a style="background-color: white!important; color: black; border-color: black;" class="btn btn-primary btn-block" href="LogoutServlet">Logout</a></div>
...
function modalEditWallet(modalID, username) {
    ...
    let modal = `
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="form" action="AddBalance2Servlet">
